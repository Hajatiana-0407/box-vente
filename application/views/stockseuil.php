                    ...
                    <table class="table">
                        <thead class="table-info">
                            <tr class="to_filtre">
                                ...
                                <th>Quantité </th>
                                <!-- Colonne Dépôt ou point de vente supprimée -->
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                                    ...
                                    <tr class="table-danger">
                                        ...
                                        <td>
                                            <?php if (  $data->type == 'telephone' && (int)$data->quantite_stk  > 0):?>
                                                <button class="btn btn-secondary detail" data-reference='<?= $data->refProduit ?>' data-id='<?= $data->idProduit ?>' data-idpointvente ='<?= $data->idPointVente  ?>'  data-bs-toggle="modal" data-bs-target="#myModal"><i class="fa fa-list"></i></button>
                                            <?php else : ?>
                                                --
                                            <?php endif  ?>
