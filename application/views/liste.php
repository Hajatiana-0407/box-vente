    ...
    <div class="wrapper">
        <div class="corps">
            <div class="stock_corps">
                ...
                <div class="onglet">
                    <a href="<?= base_url('vente') ?>" id="panier_" class="onglet_btn ">Nouvelle vente</a>
                    <a href="<?= base_url('liste') ?>" class="onglet_btn active">Liste des ventes</a>
                </div>
                        ...
                        <tbody class="search-results">
                            ...
                            <?php for ($i = 0; $i < count($data); $i++) : ?>
                                <tr>
                                    ...
                                    <td><?= $data[$i]->nomClient . " " . $data[$i]->prenomClient  ?></td>
                                    <td><?= ($data[$i]->telClient == '') ? '...' :  $data[$i]->telClient  ?></td>
                                    <td><?= number_three($data[$i]->frais) ?></td>
                                    <td><?= ($data[$i]->montant_total != '') ? number_three($data[$i]->montant_total) : '0 Ar' ?></td>
                                    <td><?= ($data[$i]->montant_payer != '') ? number_three((float)$data[$i]->montant_payer) : '0 Ar' ?></td>
                                    <td>
                                        ...
                                        <?php endif; ?>
                                        <button data-idfacture='<?= $data[$i]->idfacture ?>' data-facture='<?= $data[$i]->Facture ?>' class="btn btn-primary imprim"><i class="fas fa-print"></i></button>
                                    </td>
                                </tr>
                            <?php endfor; ?>
                        </tbody>
